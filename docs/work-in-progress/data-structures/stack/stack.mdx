...
import { StackDemo } from "@site/src/demos/tech-notes";
...
El siguiente diagrama muestra cómo funciona el principio LIFO en un stack:

```mermaid
graph TD
    A[Stack vacío] --> B[push: home]
    B --> C[push: about]
    C --> D[push: contact]
    D --> E[Stack: home > about > contact]
    E --> F[pop: contact]
    F --> G[Stack: home > about]
    G --> H[pop: about]
    H --> I[Stack: home]
```
