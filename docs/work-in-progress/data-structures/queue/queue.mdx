...
import { QueueDemo } from "@site/src/demos/tech-notes";
...
El siguiente diagrama muestra cómo funciona el principio FIFO en una cola:

```mermaid
graph TD
    A[Cola vacía] --> B[enqueue: Notificación 1]
    B --> C[enqueue: Notificación 2]
    C --> D[enqueue: Notificación 3]
    D --> E[Cola: N1, N2, N3]
    E --> F[dequeue: Notificación 1]
    F --> G[Cola: N2, N3]
    G --> H[dequeue: Notificación 2]
    H --> I[Cola: N3]
```
