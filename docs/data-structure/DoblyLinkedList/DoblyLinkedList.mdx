...
import { DoblyLinkedListDemo } from "./DoblyLinkedListDemo";

# Dobly Linked List (Lista Doblemente Enlazada)
...
## DoblyLinkedList (con `head` y `tail`)
...
### Cómo funciona una Dobly Linked List
